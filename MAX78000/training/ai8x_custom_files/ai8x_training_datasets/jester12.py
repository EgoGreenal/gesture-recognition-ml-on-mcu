###################################################################################################
# 20BN-Jester 12-frame cached dataset for ai8x-training
###################################################################################################
"""Cached 20BN-Jester 12-frame gesture dataset."""
...
class CachedJesterSplit(Dataset):
    """Single cached split stored as uint8 frame stacks."""
...
def jester12_get_datasets(data, load_train=False, load_test=False):
    """Return cached 12-frame Jester train/validation datasets."""
    data_dir, args = data

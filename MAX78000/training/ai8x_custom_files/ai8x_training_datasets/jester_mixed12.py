###################################################################################################
# 20BN-Jester mixed raw/motion cached dataset for ai8x-training
###################################################################################################
"""Cached 20BN-Jester mixed raw/motion gesture dataset."""
...
class CachedJesterSplit(Dataset):
    """Single cached split stored as uint8 mixed raw/motion stacks."""
...
def jester_mixed12_get_datasets(data, load_train=False, load_test=False):
    """Return cached 12-plane mixed raw/motion Jester train/validation datasets."""
    data_dir, args = data
...
datasets = [
    {
        ...
        "input": (12, 64, 64),
        "output": LABELS,
        "loader": jester_mixed12_get_datasets,
    }
]

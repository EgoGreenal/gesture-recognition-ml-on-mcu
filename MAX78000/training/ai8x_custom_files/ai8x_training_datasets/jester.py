###################################################################################################
# 20BN-Jester cached dataset for ai8x-training
###################################################################################################
"""Cached 20BN-Jester multi-frame gesture dataset."""
...
class CachedJesterSplit(Dataset):
    """Single cached split stored as uint8 frames."""
...
def jester_get_datasets(data, load_train=False, load_test=False):
    """Return cached Jester train/validation datasets."""
    data_dir, args = data

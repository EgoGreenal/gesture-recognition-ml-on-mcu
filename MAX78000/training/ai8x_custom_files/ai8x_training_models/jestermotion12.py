###################################################################################################
# 20BN-Jester motion-channel compact gesture network for MAX78000 deployment
###################################################################################################
"""Motion-channel Jester gesture-recognition network."""
...
class JesterMotion12Net(nn.Module):
    """2D CNN for one appearance plane plus 11 adjacent-frame motion planes."""
...
def jestermotion12(pretrained=False, **kwargs):
    """Construct a 12-plane motion-channel JesterNet model."""
    assert not pretrained
    return JesterMotion12Net(**kwargs)

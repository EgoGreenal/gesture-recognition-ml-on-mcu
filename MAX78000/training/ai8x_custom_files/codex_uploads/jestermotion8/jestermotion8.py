###################################################################################################
# 20BN-Jester 8-plane motion-channel compact gesture network for MAX78000 deployment
###################################################################################################
"""8-plane motion-channel Jester gesture-recognition network."""
...
class JesterMotion8Net(nn.Module):
    """2D CNN for one appearance plane plus seven adjacent-frame motion planes."""
...
def jestermotion8(pretrained=False, **kwargs):
    """Construct an 8-plane motion-channel JesterNet model."""
    assert not pretrained
    return JesterMotion8Net(**kwargs)

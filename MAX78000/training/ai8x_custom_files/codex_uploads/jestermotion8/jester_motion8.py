###################################################################################################
# 20BN-Jester 8-plane motion-channel cached dataset for ai8x-training
###################################################################################################
"""Cached 20BN-Jester 8-plane motion-channel gesture dataset."""
...
def jester_motion8_get_datasets(data, load_train=False, load_test=False):
    """Return cached 8-plane motion-channel Jester train/validation datasets."""
    data_dir, args = data
...
datasets = [
    {
        ...
        "input": (8, 64, 64),
        "output": LABELS,
        "loader": jester_motion8_get_datasets,
    }
]

###################################################################################################
# 20BN-Jester 12-plane motion-channel residual gesture network for MAX78000 deployment
###################################################################################################
"""Residual motion-channel Jester gesture-recognition network."""
...
class JesterMotion12ResNet(nn.Module):
    """Motion12 CNN with small low-resolution residual blocks."""
...
def jestermotion12res(pretrained=False, **kwargs):
    """Construct a residual 12-plane motion-channel JesterNet model."""
    assert not pretrained
    return JesterMotion12ResNet(**kwargs)


models = [
    {
        "name": "jestermotion12res",
        "min_input": 1,
        "dim": 2,
    }
]

###################################################################################################
# 20BN-Jester signed motion-channel compact gesture network for MAX78000 deployment
###################################################################################################
"""Signed motion-channel Jester gesture-recognition network."""
...
class JesterSignedMotion12Net(nn.Module):
    """2D CNN for one appearance plane plus 11 signed adjacent-frame motion planes."""
...
def jestersignedmotion12(pretrained=False, **kwargs):
    """Construct a 12-plane signed-motion JesterNet model."""
    assert not pretrained
    return JesterSignedMotion12Net(**kwargs)


models = [
    {
        "name": "jestersignedmotion12",
        "min_input": 1,
        "dim": 2,
    }
]

###################################################################################################
# 20BN-Jester signed-motion cached dataset for ai8x-training
###################################################################################################
"""Cached 20BN-Jester signed-motion gesture dataset."""
...
class CachedJesterSplit(Dataset):
    """Single cached split stored as uint8 signed-motion stacks."""
...
def jester_signedmotion12_get_datasets(data, load_train=False, load_test=False):
    """Return cached 12-plane signed-motion Jester train/validation datasets."""
    data_dir, args = data
...
datasets = [
    {
        "name": "jester_signedmotion12",
        "input": (12, 64, 64),
        "output": LABELS,
        "loader": jester_signedmotion12_get_datasets,
    }
]
